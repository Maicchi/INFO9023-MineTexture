...
3. **Push** both tags to Google Artifact Registry (`europe-west1-docker.pkg.dev/info9023-minetexture/minetexture/dashboard`)
4. **Deploy** the commit SHA-tagged image to the `dashboard` Cloud Run service
